...
public class KDTreeAsyncInsert {
    @State(Scope.Thread)
...
//        @Param(value = {"false","true"})
        ...
        public void setup() {
            ...
            graph.connect(new Callback<Boolean>() {
                ...
                public void on(Boolean result) {
                    ...
                    root = (KDTreeAsync) graph.newTypedNode(0,0, KDTreeAsync.NAME);
    ...
    public Object KDTreeAsyncInsert(Parameter param) {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(KDTreeAsyncInsert.class.getSimpleName())
                .build();
        new Runner(opt).run();
    }
}
